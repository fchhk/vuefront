            ...
            submitForm(formName) {
                this.$refs[formName].validate((valid) => {
                    if (valid) {
                        ...
                        params.append("btitle", this.ruleForm.title);
                        params.append("bauthor", this.ruleForm.author);
                        params.append("bcontent", this.ruleForm.content);
                        axios.post('http://localhost:8181/charity/board/register', params).then(resp => {
                            // console.log(resp)
                            if (resp.status==200){
